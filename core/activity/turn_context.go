...
// TurnContext wraps the Activity received and provides operations for the client
// program of this SDK
...
// TextMessage to be used by the client program to send a plain text Activity
